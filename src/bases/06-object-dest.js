...
// const useContext = ( {nombre, clave, edad, estado ='Inactivo'} ) => {
//     // console.log(nombre, clave, estado);
//     return {
//         nombreClave: clave,
//         anios: edad,
...
// const {estad, nombreClave, anios, latlng} = useContext( persona );
// // const {nombreClave, anios} = hunter;
...
const {estad, nombreClave, anios, latlng:{lat, lng}} = useContext( persona );
// const {nombreClave, anios} = hunter;
console.log(nombreClave, anios, estad);
console.log(lat, lng);
